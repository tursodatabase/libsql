...
impl<T: WrapWal<W>, W: Wal> Wal for WalRef<T, W> {
    ...
    fn frame_count(&self) -> super::Result<u32> {
        unsafe { (*self.wrapper).frame_count(&*self.wrapped) }
    }
    ...
    W: Wal,
{
    ...
    fn frame_count(&self) -> super::Result<u32> {
        self.wrapper.frame_count(&self.wrapped)
    }
...
pub trait WrapWal<W: Wal> {
    ...
    fn frame_count(&self, wrapped: &W) -> super::Result<u32> {
        wrapped.frame_count()
    }
