...
LIBOBJ+= alter.o analyze.o attach.o auth.o \
         ...
         fts3_snippet.o fts3_term.o fts3_tokenizer.o fts3_tokenizer1.o \
...
fts3_term.o:	$(TOP)/ext/fts3/fts3_term.c $(HDR) $(EXTHDR)
	$(TCCX) -DSQLITE_CORE -c $(TOP)/ext/fts3/fts3_term.c
