/*
** Name:        aegis128x2_avx2.c
** Purpose:     Implementation of AEGIS-128x2 - AES-NI AVX2
...
typedef __m256i aegis128x2_avx2_aes_block_t;

#define AEGIS_AES_BLOCK_T aegis128x2_avx2_aes_block_t
#define AEGIS_BLOCKS      aegis128x2_avx2_blocks
#define AEGIS_STATE      _aegis128x2_avx2_state
#define AEGIS_MAC_STATE  _aegis128x2_avx2_mac_state

#define AEGIS_FUNC_PREFIX  aegis128x2_avx2_impl
