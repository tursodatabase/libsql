...
** Purpose:     Header for implementation structure of AEGIS-256x4
...
typedef struct aegis256x4_implementation {
    ...
    void (*state_init)(aegis256x4_state *st_, const uint8_t *ad, size_t adlen, const uint8_t *npub,
                       const uint8_t *k);
    int (*state_encrypt_update)(aegis256x4_state *st_, uint8_t *c, size_t clen_max, size_t *written,
    ...
    int (*state_encrypt_final)(aegis256x4_state *st_, uint8_t *c, size_t clen_max, size_t *written,
                               size_t maclen);
    int (*state_decrypt_detached_update)(aegis256x4_state *st_, uint8_t *m, size_t mlen_max,
                                         size_t *written, const uint8_t *c, size_t clen);
    int (*state_decrypt_detached_final)(aegis256x4_state *st_, uint8_t *m, size_t mlen_max,
...
#endif /* AEGIS256X4_IMPLEMENTATIONS_H */
