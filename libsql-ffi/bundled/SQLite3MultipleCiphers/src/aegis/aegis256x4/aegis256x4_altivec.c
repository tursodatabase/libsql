...
** Purpose:     Implementation of AEGIS-256x4 - AltiVec
...
{
    return (AEGIS_AES_BLOCK_T) { vec_xor(a.b0, b.b0), vec_xor(a.b1, b.b1), vec_xor(a.b2, b.b2),
                           vec_xor(a.b3, b.b3) };
}
...
{
    return (AEGIS_AES_BLOCK_T) { vec_and(a.b0, b.b0), vec_and(a.b1, b.b1), vec_and(a.b2, b.b2),
                           vec_and(a.b3, b.b3) };
}
...
{
    return (AEGIS_AES_BLOCK_T) { vec_xl_be(0, a), vec_xl_be(0, a + 16), vec_xl_be(0, a + 32),
                           vec_xl_be(0, a + 48) };
}
